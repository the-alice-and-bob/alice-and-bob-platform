    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.JSONField(db_default=['user'], db_index=True, default=list)),
                ...
                ('email_click_rate', models.FloatField(default=0.0)),
                ('community_activity_score', models.IntegerField(default=0)),
